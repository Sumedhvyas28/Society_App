class AppUrl {
  ...
  static String getGuardNote = baseUrl + '/get-note-status';
  static String getUserNote = baseUrl + '/get-user-note-status';
  ...
  static String postGuardNote = baseUrl + '/note-to-guard';
}
