...
import 'package:society_app/new.dart';
...
import 'package:society_app/view_model/guard/note.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => GuardNoteViewModel()),
        ChangeNotifierProvider(create: (_) => NoteViewModel()),
        ChangeNotifierProvider(create: (_) => UserNoteViewModel()),
      ],
