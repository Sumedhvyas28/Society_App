...
class NotificationSAPage extends StatefulWidget {
  const NotificationSAPage({super.key});

  @override
  State<NotificationSAPage> createState() => _NotificationSAPageState();
}

class _NotificationSAPageState extends State<NotificationSAPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'Notifcaiton'),
